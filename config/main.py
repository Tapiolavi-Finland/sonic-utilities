...
@add.command()
# Main arguments
@click.argument('table-name', metavar="<table_name>", type=click.STRING, required=True)
@click.argument('rule-name', metavar="<rule_name>", type=click.STRING, required=True)
...
@click.option("--ether-type", type=click.STRING, metavar="[num|text|hex]", help="L2 Protocol ETHER_TYPE field.", required=False)
# L3 options
@click.option("--ip-protocol", type=click.STRING, metavar="[num|text]", help="L3 Protocol IP_PROTOCOL field.", required=False)
@click.option("--src-ip", type=click.STRING, metavar="[ipv4_prefix]", help="Source IPv4 address and mask.", required=False)
@click.option("--dst-ip", type=click.STRING, metavar="[ipv4_prefix]", help="Destination IPv4 address and mask", required=False)
@click.option("--src-ipv6", type=click.STRING, metavar="[ipv6_prefix]", help="Source IPv6 address and mask", required=False)
@click.option("--dst-ipv6", type=click.STRING, metavar="[ipv6_prefix]", help="Destination IPv6 address and mask", required=False)
# L4 options
@click.option("--src-l4-port", type=click.INT, metavar="[num]", help="Source L4 Port.", required=False)
@click.option("--dst-l4-port", type=click.INT, metavar="[num]", help="Destination L4 port.", required=False)
@click.option("--src-l4-port-range", type=click.STRING, metavar="[num-num]", help="Source L4 port range.", required=False)
@click.option("--dst-l4-port-range", type=click.STRING, metavar="[num-num]", help="Destination L4 port range.", required=False)
# Addition options
@click.option("--icmp-code", type=click.INT, metavar="[num]", help="ICMP_CODE field", required=False)
@click.option("--icmp-type", type=click.INT, metavar="[num]", help="ICMP_TYPE field.", required=False)
@click.option("--icmpv6-code", type=click.INT, metavar="[num]", help="ICMPV6_CODE field.", required=False)
@click.option("--icmpv6-type", type=click.INT, metavar="[num]", help="ICMPV6_TYPE field.", required=False)
@click.option("--vlan-id", type=click.INT, metavar="[num]", help="VLAN ID.", required=False)
@click.option("--src-mac", type=click.STRING, metavar="[mac_address]", help="Source MAC address field.", required=False)
@click.option("--dst-mac", type=click.STRING, metavar="[mac_address]", help="Destination MAC address field.", required=False)
@click.option("--in-ports", type=click.STRING, metavar="[text]", help="List of inbound ports to match value annotations. Format: Ethernet1,Ethernet2,Ethernet...", required=False)
@click.option("--out-ports", type=click.STRING, metavar="[text]", help="list of outbound ports to match value annotations. Format: Ethernet1,Ethernet2,Ethernet...", required=False)
@click.option("--tcp-flags", type=click.STRING, metavar="[hex/num|hex/hex]", help="TCP_FLAGS field.", required=False)
@click.option("--dscp", type=click.INT, metavar="[num]", help="DSCP field.", required=False)
# Functio variables
@click.option('--skip-validation', is_flag=True, default=False, help="Skip validation.")
@click.option('--ignore-errors', is_flag=True, default=False, help="Ignore errors.")
@click.option('--override-rule', is_flag=True, default=False, help="Override the existing rule if the new rule matches.")
def rule(
